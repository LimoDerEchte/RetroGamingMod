...
public class EmuBlockEntities {
    ...
    public static final BlockEntityType<MonitorBlockEntity> GENERIC_CONSOLE = register("console",
            FabricBlockEntityTypeBuilder.create(MonitorBlockEntity::new, EmuBlocks.NES).build());
